...
class Router
{
    ...
    public function __construct($config = [])
    {
        $defaults = [
            ...
            'classes'       => [
                ...
                'route'     => 'Ssslim\Core\Libraries\Router\Route',
                'scope'     => 'Ssslim\Core\Libraries\Router\Scope'
            ]
        ];
        $config += $defaults;
    ...
    protected function _normalizeRequest($request)
    {
        ...
        if ($this->_basePath) $request['path'] = preg_replace('~'.$this->_basePath . '~', '', $request['path']);
